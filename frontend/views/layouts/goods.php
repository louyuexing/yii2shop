    ...
    <div class="nav w1210 bc mt10">
        ...
        <div class="category fl cat1"> <!-- 非首页，需要添加cat1类 -->
            ...
            <div class="cat_bd none">
                <?php
               $result=\backend\models\GoodsCategory::findAll(['parent_id'=>0])
                ?>
...
<div class="list w1210 bc mt10">
    ...
    <div class="list_left fl mt10">
        ...
        <div class="catlist">
            <?php
           $result=\backend\models\GoodsCategory::findAll(['parent_id'=>24])?>
            <h2><?php
                $c=\backend\models\GoodsCategory::findOne(['id'=>24]);
                echo $c->name;
                ?></h2>
            <?php foreach ($result as $key=>$row):?>
            <div class="catlist_wrap">
                <div class="child">
                    <h3 class="<?=$key==0?'no':' '?>"><b></b><?=$row->name?></h3>
                    <ul class="<?=$key==0?' ':'none'?>">
                        <?php foreach ($row->children as $rs):?>
                        <li><?=$rs->name?></li>
                       <?php endforeach;?>
